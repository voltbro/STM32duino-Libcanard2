//forked from https://github.com/nopnop2002/Arduino-STM32-CAN
...
CAN_bit_timing_config_t can_configs[6] = {{2, 12, 60}, {2, 12, 30}, {2, 12, 24}, {2, 12, 12}, {2, 12, 6}, {1, 8, 4}};
